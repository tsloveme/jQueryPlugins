...
(function($){
    $.fn.pop_container =function(options){
		...
		if(isie6){
			$(apdTo).append("<iframe id='pop_back_ie6' style='filter:alpha(opacity=1);background-color:#fff;position:absolute; z-index:"+zNum+";left:0; top:0; border:0;filter:alpha(opacity=1);'></iframe>");
